...
> **SupportFlow note**: this project's existing services use `@Injectable({ providedIn: 'root' })` instead (see `creating-services.md`'s note) — the DI concepts below (`inject()`, injection context) apply identically either way.
